...
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/ru-dr/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
# run a command called 'fastfetch' after checking the powershell and profile updates

if (-not (Test-CommandExists fastfetch)) {
    Write-Error "fastfetch command not found. Please install it via winget."
} else {
    fastfetch
}
